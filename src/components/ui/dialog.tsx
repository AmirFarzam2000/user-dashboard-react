...
function DialogOverlay({
  ...
  return (
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out   data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-gray-900/50 backdrop-blur-[2px]",
        className
      )}
      {...props}
    />
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-white dark:bg-[#0a0a0a] text-foreground fixed z-50 grid w-full gap-4 border border-border/50 shadow-2xl duration-300",
